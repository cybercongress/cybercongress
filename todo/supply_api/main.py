...
def circulating_supply():
    ...
    try:
        ...
        gift_supply = int(requests.get('https://lcd.bostrom.cybernode.ai/cosmos/bank/v1beta1/balances/bostrom1qs9w7ry45axfxjgxa4jmuhjthzfvj78sxh5p6e/boot').json()['balance']['amount'])
