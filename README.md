...
That record carries what we believe in. Below, we have outlined the goals and values that we believe in the most. This is a hard mission, as our foremost wish is freedom and outlining anything when speaking of freedom is hard. 
...
Those words are not kept in their original order but they still carry the same message that we share.
...
- Social: freedom of choice, abolishing fear, bringing sociology and anthropology back to natural ways
...
We understand that technicalities are boring, but we want to be transparent. To achieve our goals we will utilize any type of appropriate technology to our values that already exists or we will create it ourselves. More details on cyber~Congress technicalities can be found [here](https://github.com/cybercongress/congress/blob/master/drafts/congress%20technicalities.md).
