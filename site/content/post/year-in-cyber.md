...
Cyber has had a very productive and filled with events 2020. Here, at [cyber\~Congress](https://client.aragon.org/#/cybercongress) (the launching DAO behind Cyber), we have decided to put together a short review of the year.
...
Further, we started to develop [an amazing onchain, automatic bounty program](https://github.com/cybercongress/cyber-foundation/blob/master/cyberfundclassic/bounty.md), which in due time, just might be developed into a separate Cyber-SDK module.
