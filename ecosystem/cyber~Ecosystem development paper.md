...
### The forming blocks
What I propose, is to separately describe each of the combining blocks of cyber~Ecosystem in detail and then conclude with a visions statement. 
...
To further grow our influence within our most important community for now - [the Cosmic commyunity](https://github.com/cosmos), I believe a set-up of a Cosmos validator is required as [per this issue](https://github.com/cybercongress/congress/issues/203). This will allow us to skate ATOM tokens as described in [our paper](https://github.com/cybercongress/cyber/blob/master/main.tex), fund our work via grants and not dump any tokens on the market. 
...
### Governance, proposals and hacking
...
We view developers as a vital part of a functioning mechanism of any technological product. This means that we will be funding [Gitcoin issues](https://gitcoin.co/cybercongress) to help us develop the protocol (and beyond) and help to build a distributed hacker community around Cyber.  
