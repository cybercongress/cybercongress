...
Without much ado, we announce the Open Bootstrap Evangelism Program or `OBEP`. Acknowledged Evangelists will be eligible to 10% of all donations in ATOMs, which they have generated during [the Game of Links](https://github.com/cybercongress/congress/blob/master/ecosystem/Cyber%20Homestead%20doc.md#game-of-links-or-gol) and other perks. To kick off the program, [vote `yes` to the evangelism proposal](https://cyber.page/governance/4).
